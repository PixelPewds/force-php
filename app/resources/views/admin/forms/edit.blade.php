        ...
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('forms.update', $form) }}" method="post" id="myForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group input-group-static mb-4">
                      <label class="ms-0">
                        <input type="checkbox" class="toggle-image" name="visibility" {{ $form->visibility ? 'checked' : '' }}>
...
@section('javascript')
  ...
  <script>
    let sectionIndex = {{ $form->sections->count() }};
