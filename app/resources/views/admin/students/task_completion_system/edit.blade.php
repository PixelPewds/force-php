...
@section('content')
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-2">
      <div class="row mb-4">
        <div class="col-md-12">
          <h3 class="mb-0 h4 font-weight-bolder">Edit Task Assignment</h3>
          ...
          <form method="POST" action="{{ route('task-completion.update', $taskCompletion) }}">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <div class="input-group input-group-static mb-4">
                  ...
                  <input type="date" name="deadline" id="deadline"
                    ...
                    value="{{ isset($taskCompletion->deadline) ? $taskCompletion->deadline->format('Y-m-d') : '' }}">
                  @error('deadline')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
              ...
              <!-- <div class="col-md-4 mb-3">
                              ...
                              <div class="mb-3">
                                <label for="admin_remarks">Initial Remarks</label>
