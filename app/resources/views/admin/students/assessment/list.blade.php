...
@section('content')
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-0">
          <h3 class="mb-0 h4 font-weight-bolder">Assessment and Reports View</h3>
          <p class="mb-1">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Registered On</th>
                      ...
                      <tr>
                        ...
                        <td>
                          <div style="display: flex; gap: 8px;">
                            <a class="btn btn-success" href="{{ route('student.edit', $user->id) }}">Progress</a>
                          </div>
                        </td>
                      </tr>
                    @endforeach
